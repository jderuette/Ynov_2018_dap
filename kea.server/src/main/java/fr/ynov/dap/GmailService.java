...
public class GmailService extends GoogleService {
  ...
  public int getUnreadMessageCount(String userKey) throws IOException {
    //TODO kea by Djer "me" est un Id sur les Serveurs de Google,
    //ici il faut uiliser un ID "de l'application"
  ...
  public String unreadMessageCountToString(@PathVariable final String user)
      throws IOException {
    return "Vous avez " + getUnreadMessageCount(user) + " mails non lus !\n";
  }
