...
import fr.ynov.dap.dap.services.GoogleService;

@Controller
//TODO mot by Djer Il pourriat être dans le package "controller"
public class GoogleAccount extends GoogleService {

	
	public GoogleAccount() throws IOException, GeneralSecurityException {
		super();
	...
	//TODO mot by Djer si pas de modifier, alors celui de la classe. Ton LOG est public ! 
	final static Logger LOG = LogManager.getLogger(GoogleAccount.class);
    ...
    public String oAuthCallback(@RequestParam final String code, final HttpServletRequest request,
        ...
        final String redirectUri = buildRedirectUri(request, super.getConfig().getoAuth2CallbackUrl());
        ...
        try {
            ...
            if (LOG.isDebugEnabled()) {
                //TODO mot by Djer Pourquoi supprimer une log uitle quand ca "plante" ? A cause des 2 constantes ?
                //if (null != credential && null != credential.getAccessToken()) {
        ...
        //TODO mot by Djer es-tu sure d'avoir un mapping sur / ?
        return "redirect:/";
    }
    ...
    public String addAccount(@PathVariable final String userId, final HttpServletRequest request,
        ...
        try {
            ...
            if (credential != null && credential.getAccessToken() != null) {
                ...
                authorizationUrl.setRedirectUri(buildRedirectUri(request, super.getConfig().getoAuth2CallbackUrl()));
