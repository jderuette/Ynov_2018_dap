...
//TODO jog by Djer Configure tes "save actions" dans Eclipse !! Cf mémo Eclipse
...
public class GoogleAccount extends GoogleService {
	...
	public String oAuthCallback(@RequestParam final String code, final HttpServletRequest request,
		...
		try {
			...
			//TODO job by Djer Pourquoi supprimer cette LOG utile quand ca "déconne" ?? A cause des 2 constantes ?
