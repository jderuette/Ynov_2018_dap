 ...
 */
@Controller
//TODO plp by Djer Devrait être dans le package "Web"
public class GoogleAccount extends GoogleService {
    ...
    private Logger log = LogManager.getLogger("GoogleAccount");
    ...
    public final String oAuthCallback(@RequestParam final String code, final HttpServletRequest request,
        ...
        //TODO plp by Djer Es-tu sure d'avoir un mapping sur / ?
        return "redirect:/";
    }
