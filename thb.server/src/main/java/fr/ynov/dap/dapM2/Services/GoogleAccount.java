 ...
 */
@Controller
//TODO thb by Djer Comme c'est un controller, il devrait être dans le package "controllers".
    ...
    public String oAuthCallback(@RequestParam final String code, final HttpServletRequest request,
        ...
        try {
            ...
            if (LOG.isDebugEnabled()) {
                //TODO thb by Djer Pourquoi enlever ce debug SUPER utile c=quand il y a un probleme ? A cause des 2 constantes à créer ?
                //if (null != credential && null != credential.getAccessToken()) {
        ...
        //TODO thb by Djer Es-tu sure d'avoir un mapping sur / ?
        return "redirect:/";
    }
