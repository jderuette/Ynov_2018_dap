...
public final class Launcher {
    ...
    public static void main(final String[] args) throws IOException, URISyntaxException {
        ...
        if (args[0].equals("add")) {
            if (args[1] != null) {
                //Pas vraiment utile d'afficher le HTML sur la page Google sur le client néanmoins est là
                //pour le développement, à supprimer plus tard
     ...
     * @throws IOException .
     */
    public static void getRequestNextEvent(final String url) throws IOException {
     ...
     * @throws IOException .
     */
    public static void getRequestNbPeople(final String url) throws IOException {
