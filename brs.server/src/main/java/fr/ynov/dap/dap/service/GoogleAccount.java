 ...
 */
@Controller
public class GoogleAccount extends GoogleServices {

	/** The Constant LOG. */
    //TODO brs by Djer Final ?
	...
	public String oAuthCallback(@RequestParam final String code, final HttpServletRequest request,
		...
		try {
			...
			LOG.info("New user credential stored with userId : " + userId + "partial AccessToken : "
		...
		return "redirect:/getEmails/getLabel/userKey=" + userId;
	}
	 ...
	 * @throws GeneralSecurityException the general security exception
	 */
	@RequestMapping("/account/add/userKey={userId}")
