...
public class GoogleAccountService extends GoogleService {
    ...
    public String oAuthCallback(String code, HttpServletRequest request,
        ...
        //TODO zal by DJer Es-tu sur d'avoir un mapping sur / ?
        return "redirect:/";
    }
     ...
     */
    //TODO zal by Djer Bien d'avoir transformé en service, et extrait le controller. Mais un service metier qui dépend de "Request".
    // Ce n'est pas top. Essaye de rendre ce service indépendant de HttpServletRequest (et HttpSession)
    public String addAccount(final String userId, final HttpServletRequest request,
        ...
        try {
            ...
            if (credential != null && credential.getAccessToken() != null) {
                ...
                authorizationUrl.setRedirectUri(buildRedirectUri(request, getCfg().getoAuth2CallbackUrl()));
