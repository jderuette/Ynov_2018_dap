package fr.ynov.dap.dap.service.microsoft.builder;
...
public class OutlookServiceBuilder {
	 ...
	 */
	public static OutlookRequestService getOutlookService(String accessToken, String userEmail) {
		...
		return retrofit.create(OutlookRequestService.class);
	}
}